...
def reply_document_blur(blur_pages): 
    return "Dokumen yang anda kirim memiliki _*blur*_ pada halaman " + str(blur_pages) + ", mohon ambil ulang gambar pada halaman tersebut"
...
def reply_image_blur():
    return "Gambar yang anda kirim memiliki _*blur*_, mohon ambil ulang gambar tersebut"
...
def reply_document_blur_too_long(blur_pages): 
    return "Dokumen yang anda kirim memiliki _*blur*_ pada halaman " + str(blur_pages) + " pada 100 halaman pertama, mohon ambil ulang gambar pada halaman tersebut"
